...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Assert.AreEqual error Sue != to Bob, the person is not being dequeued
    //
    ...
    // Defect(s) Found: for loope Assert.AreEqual Sue != Bob  There is no way to add new people to the queue 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: for loop Sue != Bob Tim should dequeue and re-queue continually due to timTurns
    ...
    // Defect(s) Found: for loop Sue != Bob -3 turns is 0 or less so they never end
    ...
    // Defect(s) Found: no defects green check mark
